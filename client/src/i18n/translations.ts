...
export const translations = {
  ...
  // ── Schedules (cron-style task scheduler) ──
  'nav.schedules': { en: 'Schedules', ru: 'Расписания', kz: 'Кестелер' },
  'schedules.title': { en: 'Scheduled tasks', ru: 'Расписание задач', kz: 'Кесте бойынша тапсырмалар' },
  'schedules.subtitle': {
    en: 'Run bulk actions automatically on cron — reboot a group every Monday 03:00, push a script to all dev machines every hour, etc.',
    ru: 'Запускай bulk-действия по cron — например ребут группы каждый понедельник в 03:00 или прогон скрипта раз в час.',
    kz: 'Cron бойынша топтық әрекеттерді автоматты түрде орындаңыз — мысалы, дүйсенбі сайын 03:00-де топты қайта жүктеу немесе сағат сайын скрипт жіберу.',
  },
  'schedules.create': { en: 'New schedule', ru: 'Новое расписание', kz: 'Жаңа кесте' },
  'schedules.edit': { en: 'Edit schedule', ru: 'Изменить расписание', kz: 'Кестені өзгерту' },
  'schedules.name': { en: 'Name', ru: 'Название', kz: 'Атауы' },
  'schedules.namePlaceholder': { en: 'e.g. Nightly accounting reboot', ru: 'напр. Ночной ребут бухгалтерии', kz: 'мыс. Түнгі есеп қайта жүктеу' },
  'schedules.cron': { en: 'Cron expression', ru: 'Cron-выражение', kz: 'Cron өрнегі' },
  'schedules.cronHelp': {
    en: 'Five fields: minute hour day-of-month month day-of-week. Examples: "0 3 * * *" = every day at 03:00, "*/15 * * * *" = every 15 min, "0 9-17 * * 1-5" = hourly on weekdays 9-17.',
    ru: 'Пять полей: минута час день-месяца месяц день-недели. Примеры: "0 3 * * *" = каждый день в 03:00, "*/15 * * * *" = каждые 15 мин, "0 9-17 * * 1-5" = по будням 9-17 ежечасно.',
    kz: 'Бес өріс: минут сағат күн ай апта-күні. Мысалдар: «0 3 * * *» = күн сайын 03:00-де, «*/15 * * * *» = әр 15 минут сайын, «0 9-17 * * 1-5» = жұмыс күндері 9-17 сағатына.',
  },
  'schedules.action': { en: 'Action', ru: 'Действие', kz: 'Әрекет' },
  'schedules.actionExecute': { en: 'Run command', ru: 'Выполнить команду', kz: 'Команда орындау' },
  'schedules.actionReboot': { en: 'Reboot', ru: 'Перезагрузить', kz: 'Қайта жүктеу' },
  'schedules.actionShutdown': { en: 'Shutdown', ru: 'Выключить', kz: 'Өшіру' },
  'schedules.actionLockscreen': { en: 'Lock screen', ru: 'Заблокировать экран', kz: 'Экранды құлыптау' },
  'schedules.actionAlarm': { en: 'Sound alarm', ru: 'Сигнализация', kz: 'Дабыл' },
  'schedules.command': { en: 'Command', ru: 'Команда', kz: 'Команда' },
  'schedules.commandPlaceholder': { en: 'e.g. powershell -c "Restart-Service Spooler"', ru: 'напр. powershell -c "Restart-Service Spooler"', kz: 'мыс. powershell -c "Restart-Service Spooler"' },
  'schedules.target': { en: 'Target', ru: 'Цель', kz: 'Мақсат' },
  'schedules.targetGroup': { en: 'Group', ru: 'Группа', kz: 'Топ' },
  'schedules.targetAgents': { en: 'Specific agents', ru: 'Конкретные агенты', kz: 'Нақты агенттер' },
  'schedules.selectGroup': { en: '— select group —', ru: '— выбери группу —', kz: '— топты таңда —' },
  'schedules.selectAgents': { en: '— pick agents —', ru: '— выбери агентов —', kz: '— агенттерді таңда —' },
  'schedules.enabled': { en: 'Enabled', ru: 'Включено', kz: 'Қосулы' },
  'schedules.disabled': { en: 'Disabled', ru: 'Выключено', kz: 'Өшірулі' },
  'schedules.save': { en: 'Save', ru: 'Сохранить', kz: 'Сақтау' },
  'schedules.cancel': { en: 'Cancel', ru: 'Отмена', kz: 'Бас тарту' },
  'schedules.delete': { en: 'Delete', ru: 'Удалить', kz: 'Жою' },
  'schedules.runNow': { en: 'Run now', ru: 'Запустить сейчас', kz: 'Қазір орындау' },
  'schedules.lastRun': { en: 'Last run', ru: 'Последний запуск', kz: 'Соңғы орындалу' },
  'schedules.never': { en: 'never', ru: 'не было', kz: 'болмаған' },
  'schedules.empty': {
    en: 'No schedules yet. Create one above to run bulk actions automatically on cron.',
    ru: 'Расписаний пока нет. Создай выше, чтобы запускать bulk-действия по cron автоматически.',
    kz: 'Әзірге кестелер жоқ. Bulk-әрекеттерді cron бойынша автоматты түрде орындау үшін жоғарыдан жасаңыз.',
  },
  'schedules.confirmDelete': {
    en: 'Delete schedule "{name}"? It will stop firing immediately.',
    ru: 'Удалить расписание «{name}»? Оно сразу перестанет срабатывать.',
    kz: '«{name}» кестесін жою керек пе? Ол бірден жұмысын тоқтатады.',
  },
  'schedules.runNowOk': { en: 'Triggered "{name}" — sent={sent} skipped={skipped}', ru: 'Запущено «{name}» — отправлено={sent}, пропущено={skipped}', kz: '«{name}» қосылды — жіберілді={sent}, өткізілді={skipped}' },
  'schedules.runNowFailed': { en: 'Run failed: {error}', ru: 'Запуск не удался: {error}', kz: 'Орындау сәтсіз: {error}' },
  'schedules.invalidCron': { en: 'Invalid cron expression: {error}', ru: 'Некорректный cron: {error}', kz: 'Дұрыс емес cron: {error}' },
  'schedules.results': { en: 'Result', ru: 'Результат', kz: 'Нәтиже' },
  'schedules.resultSent': { en: '{n} sent', ru: 'отправлено {n}', kz: 'жіберілді {n}' },
  'schedules.resultSkipped': { en: '{n} skipped', ru: 'пропущено {n}', kz: 'өткізілді {n}' },
  'schedules.cronPresetTitle': { en: 'Quick presets', ru: 'Готовые шаблоны', kz: 'Дайын үлгілер' },
  'schedules.preset.everyMin': { en: 'every minute', ru: 'каждую минуту', kz: 'минут сайын' },
  'schedules.preset.every5': { en: 'every 5 min', ru: 'каждые 5 мин', kz: 'әр 5 минут' },
  'schedules.preset.every15': { en: 'every 15 min', ru: 'каждые 15 мин', kz: 'әр 15 минут' },
  'schedules.preset.hourly': { en: 'hourly', ru: 'ежечасно', kz: 'сағат сайын' },
  'schedules.preset.daily3am': { en: 'every day 03:00', ru: 'каждый день 03:00', kz: 'күн сайын 03:00' },
  'schedules.preset.weekday9': { en: 'weekdays 09:00', ru: 'по будням 09:00', kz: 'жұмыс күндері 09:00' },
  'schedules.preset.monday3am': { en: 'Mon 03:00', ru: 'Пн 03:00', kz: 'Дс 03:00' },
  'schedules.preset.firstOfMonth': { en: '1st of month 00:00', ru: '1-го числа 00:00', kz: 'айдың 1-ші 00:00' },

  // ── Audit log (admin) ──
  'nav.audit': { en: 'Audit log', ru: 'Аудит-лог', kz: 'Аудит журналы' },
  'audit.title': { en: 'Audit log', ru: 'Аудит-лог', kz: 'Аудит журналы' },
  'audit.subtitle': {
    en: 'Compliance-grade view of every system action — who, when, what. Filter, search, paginate, and export to CSV for offline review.',
    ru: 'Полный список всех действий в системе — кто, когда, что. Фильтры, поиск, пагинация, экспорт в CSV.',
    kz: 'Жүйедегі барлық әрекеттердің толық тізімі — кім, қашан, не. Сүзгілер, іздеу, беттеу, CSV-ке экспорт.',
  },
  'audit.refresh': { en: 'Refresh', ru: 'Обновить', kz: 'Жаңарту' },
  'audit.exportCsv': { en: 'Export CSV', ru: 'Экспорт CSV', kz: 'CSV экспорт' },
  'audit.search': { en: 'Search message / agent / actor', ru: 'Поиск по тексту / агенту / автору', kz: 'Мәтін / агент / автор бойынша іздеу' },
  'audit.filterType': { en: 'Type', ru: 'Тип', kz: 'Түрі' },
  'audit.filterActor': { en: 'Actor', ru: 'Кто', kz: 'Кім' },
  'audit.filterAgent': { en: 'Agent', ru: 'Агент', kz: 'Агент' },
  'audit.filterAll': { en: 'All', ru: 'Все', kz: 'Барлығы' },
  'audit.from': { en: 'From', ru: 'С', kz: 'Бастап' },
  'audit.to': { en: 'To', ru: 'По', kz: 'Дейін' },
  'audit.clearFilters': { en: 'Clear filters', ru: 'Сбросить фильтры', kz: 'Сүзгіні тазарту' },
  'audit.timestamp': { en: 'Timestamp', ru: 'Время', kz: 'Уақыт' },
  'audit.type': { en: 'Type', ru: 'Тип', kz: 'Түрі' },
  'audit.actor': { en: 'Actor', ru: 'Автор', kz: 'Автор' },
  'audit.agent': { en: 'Agent', ru: 'Агент', kz: 'Агент' },
  'audit.message': { en: 'Message', ru: 'Сообщение', kz: 'Хабарлама' },
  'audit.system': { en: '— system —', ru: '— система —', kz: '— жүйе —' },
  'audit.empty': { en: 'No audit entries match the current filters.', ru: 'Нет записей под выбранные фильтры.', kz: 'Таңдалған сүзгілер бойынша жазбалар жоқ.' },
  'audit.loading': { en: 'Loading…', ru: 'Загрузка…', kz: 'Жүктелуде…' },
  'audit.pageOf': { en: 'Page {page} of {total}', ru: 'Страница {page} из {total}', kz: '{page}/{total} бет' },
  'audit.prev': { en: 'Prev', ru: 'Назад', kz: 'Алдыңғы' },
  'audit.next': { en: 'Next', ru: 'Вперёд', kz: 'Келесі' },
  'audit.shown': { en: 'Showing {shown} of {total}', ru: 'Показано {shown} из {total}', kz: '{shown}/{total} көрсетілген' },
  'audit.pageSize': { en: 'Per page', ru: 'На странице', kz: 'Бетте' },
  'audit.exporting': { en: 'Exporting…', ru: 'Экспорт…', kz: 'Экспорт…' },
  'audit.exportFailed': { en: 'Export failed: {error}', ru: 'Экспорт не удался: {error}', kz: 'Экспорт сәтсіз: {error}' },
  ...
  'backup.subtitle': {
    en: 'Export the persisted dashboard state or restore a previous snapshot.',
    ru: 'Экспортируйте состояние сервера или восстановите его из ранее сохранённого снимка.',
    kz: 'Серверлік деректерді экспорттаңыз немесе бұрынғы көшірмеден қалпына келтіріңіз.',
  },
  'backup.adminOnly': {
    en: 'Admin role is required to manage backups.',
    ru: 'Только администратор может управлять резервными копиями.',
    kz: 'Сақтық көшірмелерді тек әкімші басқара алады.',
  },
  'backup.noticeSecrets': {
    en: 'Backups include events, alerts, scripts, schedules, webhooks, groups and chat history. They do NOT include user passwords, JWT secrets, or 2FA secrets.',
    ru: 'Бэкап включает события, алерты, скрипты, расписания, вебхуки, группы и чат. Пароли пользователей, JWT- и 2FA-секреты — не включаются.',
    kz: 'Сақтық көшірмеге оқиғалар, ескертулер, сценарийлер, кестелер, вебхуктер, топтар және чат кіреді. Парольдер, JWT және 2FA құпиялары қосылмайды.',
  },
  'backup.exportTitle': { en: 'Export backup', ru: 'Экспорт резервной копии', kz: 'Сақтық көшірме экспорты' },
  'backup.exportDesc': {
    en: 'Download a gzipped JSON file with the current state. Optional password enables AES-256-GCM encryption.',
    ru: 'Скачать gzip-JSON со снапшотом. Пароль (опционально) включает AES-256-GCM шифрование.',
    kz: 'Ағымдағы күйдің gzip-JSON файлын жүктеу. Құпия сөз (қаласаңыз) AES-256-GCM шифрлауын қосады.',
  },
  'backup.passwordOptional': { en: 'Password (optional)', ru: 'Пароль (по желанию)', kz: 'Құпия сөз (қаласаңыз)' },
  'backup.passwordPlaceholder': { en: 'Leave empty for plaintext', ru: 'Оставьте пустым для plaintext', kz: 'Бос қалдыру шифрлаусыз' },
  'backup.passwordHint': {
    en: 'If set, you will need this password to restore the backup. Cannot be recovered.',
    ru: 'Если задан — этот пароль понадобится для восстановления. Восстановить нельзя.',
    kz: 'Орнатылса — қалпына келтіру үшін осы құпия сөз қажет. Қалпына келтіру мүмкін емес.',
  },
  'backup.exportButton': { en: 'Export backup', ru: 'Экспортировать', kz: 'Экспорттау' },
  'backup.exporting': { en: 'Exporting…', ru: 'Экспорт…', kz: 'Экспорт…' },
  'backup.exportSuccess': { en: 'Backup downloaded', ru: 'Бэкап скачан', kz: 'Сақтық көшірме жүктелді' },
  'backup.exportFailed': { en: 'Backup failed', ru: 'Не удалось создать бэкап', kz: 'Сақтық көшірме жасалмады' },
  'backup.restoreTitle': { en: 'Restore from backup', ru: 'Восстановить из копии', kz: 'Көшірмеден қалпына келтіру' },
  'backup.restoreDesc': {
    en: 'Upload a backup file. Preview its contents first, then apply — this overwrites the current state.',
    ru: 'Загрузите файл бэкапа, сначала посмотрите состав, затем примените — текущее состояние будет перезаписано.',
    kz: 'Сақтық көшірме файлын жүктеп, алдымен қарап шығыңыз, содан кейін қолданыңыз — ағымдағы күй қайта жазылады.',
  },
  'backup.restorePassword': { en: 'Password (if encrypted)', ru: 'Пароль (если бэкап шифрован)', kz: 'Құпия сөз (шифрланған болса)' },
  'backup.restorePasswordPlaceholder': { en: 'Required for encrypted backups', ru: 'Нужен для шифрованных бэкапов', kz: 'Шифрланған көшірмелерге қажет' },
  'backup.previewButton': { en: 'Preview', ru: 'Посмотреть состав', kz: 'Қарау' },
  'backup.restoreButton': { en: 'Restore (overwrites!)', ru: 'Восстановить (перезапишет!)', kz: 'Қалпына келтіру (қайта жазады!)' },
  'backup.restoring': { en: 'Restoring…', ru: 'Восстановление…', kz: 'Қалпына келтірілуде…' },
  'backup.restoreSuccess': { en: 'Backup restored', ru: 'Бэкап восстановлен', kz: 'Сақтық көшірме қалпына келтірілді' },
  'backup.restoreFailed': { en: 'Restore failed', ru: 'Не удалось восстановить', kz: 'Қалпына келтіру сәтсіз аяқталды' },
  'backup.confirmRestore': {
    en: 'This will OVERWRITE the current dashboard state (events, alerts, scripts, schedules, webhooks, groups, chat). Continue?',
    ru: 'Это ПЕРЕЗАПИШЕТ текущие данные дашборда (события, алерты, скрипты, расписания, вебхуки, группы, чат). Продолжить?',
    kz: 'Бұл ағымдағы дашборд деректерін (оқиғалар, ескертулер, сценарийлер, кестелер, вебхуктер, топтар, чат) ҚАЙТА ЖАЗАДЫ. Жалғастырамыз ба?',
  },
  'backup.meta.createdAt': { en: 'Created at', ru: 'Создан', kz: 'Жасалды' },
  'backup.meta.version': { en: 'Format', ru: 'Формат', kz: 'Формат' },
  'backup.meta.encrypted': { en: 'Encrypted', ru: 'Шифрован', kz: 'Шифрланған' },
  'backup.meta.notEncrypted': { en: 'Not encrypted', ru: 'Без шифрования', kz: 'Шифрсыз' },
  'backup.summary.events': { en: 'Events', ru: 'События', kz: 'Оқиғалар' },
  'backup.summary.alerts': { en: 'Alerts', ru: 'Алерты', kz: 'Ескертулер' },
  'backup.summary.alertRules': { en: 'Alert rules', ru: 'Правила', kz: 'Ережелер' },
  'backup.summary.scripts': { en: 'Scripts', ru: 'Скрипты', kz: 'Сценарийлер' },
  'backup.summary.webhooks': { en: 'Webhooks', ru: 'Вебхуки', kz: 'Вебхуктер' },
  'backup.summary.schedules': { en: 'Schedules', ru: 'Расписания', kz: 'Кестелер' },
  'backup.summary.groups': { en: 'Groups', ru: 'Группы', kz: 'Топтар' },
  'backup.summary.chatThreads': { en: 'Chat threads', ru: 'Чаты', kz: 'Чаттар' },
