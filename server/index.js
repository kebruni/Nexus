...
// ── Backup / Restore API ──────────────────────────────────
// Admin-only. Backs up the persisted store (events, alerts, alert
// rules, scripts, webhooks, schedules, chat threads, groups). Does
// NOT include .data/secrets.json — JWT secrets, password hashes and
// TOTP secrets stay on the host so a backup file can't impersonate
// any user.
