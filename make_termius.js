...
const filePath = path.join(__dirname, 'client', 'src', 'components', 'FileTransfer.tsx');
let content = fs.readFileSync(filePath, 'utf-8');

// The marker where the JSX starts
const marker = 'return (';
...
const topPart = content.substring(0, idx);
...
fs.writeFileSync(filePath, finalFile, 'utf-8');
